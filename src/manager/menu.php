...
<head>
    ...
    <title><?= ucfirst($_SESSION['title']) ?> Tambah Menu | CSO</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="menu.php">
                            <i class="icon-grid mr-2 text-light" data-feather="list"></i>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Tambah menu <button type="button" class="btn btn-success px-3 py-1" data-toggle="modal" data-target="#addUser"><span style="font-size: 18px;">+</span></button></h3>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="../../app/manager/tambah.php" method="POST">
                                        <label for="nama_menu">Nama Menu :</label>
                                        <input type="text" required name="nama_menu" autofocus class="form-control" placeholder="Masukkan nama_menu user" id="nama_menu">

                                        <label for="harga" style="margin-top: 10px;">Harga :</label>
                                        <input type="text" required name="harga" id="harga" class="form-control" placeholder="Masukkan harga user" id="harga">
                                </div>
